...
class Rule {
    ...
    // they all take the array of dice
    sum(dice) {
      // sum of all dice
    ...
    freq(dice) {
      // frequencies of dice values | tallies results of dice rolls, not specific results
      // eg freq([4,4,4,3,2]) gives [3,1,1]
      const freqs = new Map(); /* creates new array, results of a calling a 
      provided function on every element of array */
